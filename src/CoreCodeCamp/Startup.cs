...
namespace CoreCodeCamp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection svcs)
        {
            ...
            svcs.AddDbContext<CodeCampContext>(options =>
            {
                var connStr = @"Data Source=bostongab-svr.database.windows.net;Initial Catalog=bostongab;Connect Timeout=30;";
        ...
        private void SetupLoggerly(ILoggerFactory loggerFactory, IApplicationLifetime appLifetime, IConfiguration config)
        {
            ...
            // Setup Host
            logConfig.Transport.EndpointHostname = config["Loggerly-Endpoint-Hostname"];
